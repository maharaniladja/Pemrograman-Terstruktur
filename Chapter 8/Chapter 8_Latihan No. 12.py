...
if pilih == "A":
    ...
    hapusdatabuah = input("Masukkan nama buah yang akan dihapus : ")
    if hapusdatabuah not in databuah:
        print("Maaf, data tidak ditemukan")
    else:
        del(databuah[hapusdatabuah])
        print("Data buah berhasil dihapus. Data saat ini yaitu ", databuah)
